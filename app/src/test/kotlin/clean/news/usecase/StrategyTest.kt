...
import clean.news.usecase.Strategy.Companion.DISK
import clean.news.usecase.Strategy.Companion.MEMORY
import clean.news.usecase.Strategy.Companion.NETWORK
...
class StrategyTest {
	...
	private fun createMockObservableSet(
			...
			networkDelay: Long = StrategyTest.networkDelay): MockSet<Int> {
		...
		return MockSet(disk, memory, network, scheduler)
	}
